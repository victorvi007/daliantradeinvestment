...
<div class="">
    ...
    <div class=" ">
        ...
        <div class="row">
            ...
            <form action="{{ route('approve/{user_id}/') }}" method="post">
                @csrf
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <div class="p-2 my-2 d-flex justify-content-between">
                            <h6>Name</h6>
                            <h6 class="text-success">{{ $payment->user->name }}</h6>
                            
                        </div>
                        <div class="p-2 my-2 d-flex justify-content-between">
                            <h6>Email</h6>
                            <h6 class="text-success">{{ $payment->user->email }}</h6>
                            
                        </div>
                        <div class="p-2 my-2 d-flex justify-content-between">
                            <h6>Username</h6>
                            <h6 class="text-success">{{ $payment->user->username }}</h6>
                        ...
                        <div class="form-group text-end p-1">
                            <button type="submit" class="btn btn-success text-light w-50 py-2">Approve</button>
                        </div>
                    </div>
                </div>
